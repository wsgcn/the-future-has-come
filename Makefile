DEV_PATH=/home/souche/dev/souche-f2e/projects/dafengche/start-demo
PREPUB_PATH=/home/souche/prepub/souche-f2e/projects/dafengche/start-demo
ONLINE_PATH=/home/souche/online/souche-f2e/projects/dafengche/start-demo
...
init-git:
	...
	@git add .
	@git commit -m "init dafengche-start-demo"
...
publish-dev:
	...
	@echo "Please visit http://f2e.souche.com/projects/dafengche/start-demo"

publish-prepub:
	@ssh $(REMOTE_SERVER) 'mkdir -p $(PREPUB_PATH)'
	rsync -rvI --delete-after --progress $(SOURCE_FILES) $(REMOTE_SERVER):$(PREPUB_PATH)
	@echo "Please visit http://f2e.prepub.souche.com/projects/dafengche/start-demo"

publish-prod:
	@ssh $(REMOTE_SERVER) 'mkdir -p $(ONLINE_PATH)'
	rsync -rvI --delete-after --progress $(SOURCE_FILES) $(REMOTE_SERVER):$(ONLINE_PATH)
	@echo "Please visit http://f2e-assets.souche.com/projects/dafengche/start-demo"
